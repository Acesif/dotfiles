...
sudo pacman -Sy --noconfirm libxft libxinerama vim neovim wmname udiskie xbindkeys xcompmgr numlockx xwallpaper xdotool python-pywal noto-fonts-emoji lf firefox
